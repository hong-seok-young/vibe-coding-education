...
APIS_PAGE = '''
  <section class="page" data-page="apis" id="apis">
    ...
    <div class="criteria-box">
      <p class="criteria-label">무료 — 건설 업무에 바로 쓸 만한 것</p>
      <ul>
        <li><strong>나라장터 입찰공고</strong> (조달청) — 공사·물품 입찰 공고를 업종·지역·금액으로
          매일 받기. <strong>오늘 만든 것과 구조가 완전히 같다</strong> — 영업·견적 업무에 바로 쓴다.
          <br>발급: <a href="https://www.data.go.kr/" target="_blank" rel="noopener">공공데이터포털</a></li>
        <li><strong>기상청 단기예보·특보</strong> — 강우·강풍 예보로 현장 작업중지 판단, 공정 조정.
          <br>발급: 공공데이터포털</li>
        <li><strong>에어코리아 대기질</strong> — 미세먼지 경보, 옥외작업·비산먼지 관리.
          <br>발급: 공공데이터포털</li>
        <li><strong>공휴일 정보</strong> (한국천문연구원) — <strong>공정표 작업일수 계산.</strong>
          단순하지만 활용도가 가장 높은 축에 든다. <br>발급: 공공데이터포털</li>
        <li><strong>국토부 아파트 실거래가</strong> — 매매·전월세 실거래, 분양·개발 검토.
          <br>발급: 공공데이터포털</li>
        <li><strong>건축물대장</strong> (건축HUB) — 부지·건물 제원 조회. <br>발급: 공공데이터포털</li>
        <li><strong>한국은행 ECOS</strong> — 금리·환율·건설기성 등 경제통계. 하루 2만 건.
          <br>발급: <a href="https://ecos.bok.or.kr/api/" target="_blank" rel="noopener">ecos.bok.or.kr/api</a></li>
        <li><strong>KOSIS 국가통계포털</strong> — 건설수주액, 자재 물가지수. 하루 2만 건.
          <br>발급: <a href="https://kosis.kr/openapi/" target="_blank" rel="noopener">kosis.kr/openapi</a></li>
        <li><strong>카카오 로컬</strong> — 주소를 좌표로 바꾸기, 현장 위치 지도. 하루 10만 건.
          <br>발급: <a href="https://developers.kakao.com/" target="_blank" rel="noopener">developers.kakao.com</a></li>
        <li><strong>네이버 개발자센터</strong> — 뉴스·블로그 검색(구글 뉴스의 대안), 하루 2만 5천 건.
          <br>발급: <a href="https://developers.naver.com/" target="_blank" rel="noopener">developers.naver.com</a></li>
        <li><strong>구글 뉴스</strong> — 오늘 쓴 것. <strong>인증키가 아예 없다.</strong>
          다만 구글이 공식 지원한다고 밝힌 적이 없어 언제든 바뀔 수 있다.</li>
        <li><strong>DART 전자공시</strong> — 오늘 쓴 것. 하루 2만 건, 계정당 인증키 1개, 개인은 즉시 발급.
          <br>발급: <a href="https://opendart.fss.or.kr/" target="_blank" rel="noopener">opendart.fss.or.kr</a></li>
      </ul>
    </div>
    ...
    <div class="criteria-box">
      ...
      <ul>
        <li><strong>AI API</strong> (Claude 등) — 모아온 기사를 <strong>요약·분류하거나 중요도를
          매기는</strong> 데 쓴다. 오늘 만든 리포트에 붙이면 「읽을 것만 골라주는」 봇이 된다.
          무료 한도가 아니라 <strong>쓴 만큼 과금</strong>된다 (선불 충전).
          <br>가격은 글자 100만 자 단위로 매겨지고, 모델에 따라 대략 다음과 같다 —
          <strong>가벼운 모델은 100만 글자에 1달러대, 가장 좋은 모델은 5달러대</strong>
          (받는 답변 쪽이 5배쯤 비싸다). 기사 몇백 건 요약은 몇백 원 수준이다.
          <br>발급: <a href="https://console.anthropic.com/" target="_blank" rel="noopener">console.anthropic.com</a>
          — 다만 <strong>사내 결제·보안 검토가 먼저다. DX팀에 문의할 것.</strong></li>
        <li><strong>유료 데이터 서비스</strong> — 증권사 시세, 신용평가, 해외 입찰정보 등은
          계약이 필요하다. 개인이 발급받는 성격이 아니다.</li>
      </ul>
    </div>
